...
var app = new Vue({
    ...
    <b-row align="center" class="app_column">
                ...
                <b-collapse id="collapseHelp">
                    <div class="nested_list">
                        ...
                        <ol>
                            ...
                            <li><p>On the Addac 511 module, press MENU > UPDATE BOOTLOADER. Alternatively, press both white buttons (RESET + BOOT) on the back of the module, and release the RESET button first.</p></li>
        ...
        <b-row align="between" hidden="true">
